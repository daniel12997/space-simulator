...
inline constexpr std::array<std::array<double, kStencil>, kRows> kB = {{
    ...
    {f({25713, 89600}), f({-9401029, 3628800}), f({5393233, 518400}), f({-9839609, 403200}),
     f({167287, 4536}), f({-135352319, 3628800}), f({10219841, 403200}), f({-40987771, 3628800}),
     f({3288521, 1036800})},
    // Row 1 (paper-j=-4):
    {f({19087, 89600}), f({-427487, 725760}), f({3498217, 3628800}), f({-500327, 403200}),
     f({6467, 5670}), f({-2616161, 3628800}), f({24019, 80640}), f({-263077, 3628800}),
     f({8183, 1036800})},
    // Row 2 (paper-j=-3):
    {f({8183, 1036800}), f({57251, 403200}), f({-1106377, 3628800}), f({218483, 725760}),
     f({-69, 280}), f({530177, 3628800}), f({-210359, 3628800}), f({5533, 403200}),
     f({-425, 290304})},
    // Row 3 (paper-j=-2):
    {f({-425, 290304}), f({76453, 3628800}), f({5143, 57600}), f({-660127, 3628800}),
     f({661, 5670}), f({-4997, 80640}), f({83927, 3628800}), f({-19109, 3628800}), f({7, 12800})},
    // Row 4 (paper-j=-1):
    {f({7, 12800}), f({-23173, 3628800}), f({29579, 725760}), f({2497, 57600}), f({-2563, 22680}),
     f({172993, 3628800}), f({-6463, 403200}), f({2497, 725760}), f({-2497, 7257600})},
    // Row 5 (paper-j= 0):
    {f({-2497, 7257600}), f({1469, 403200}), f({-68119, 3628800}), f({252769, 3628800}), f({0, 1}),
     f({-252769, 3628800}), f({68119, 3628800}), f({-1469, 403200}), f({2497, 7257600})},
    // Row 6 (paper-j=+1):
    {f({2497, 7257600}), f({-2497, 725760}), f({6463, 403200}), f({-172993, 3628800}),
     f({2563, 22680}), f({-2497, 57600}), f({-29579, 725760}), f({23173, 3628800}), f({-7, 12800})},
    // Row 7 (paper-j=+2):
    {f({-7, 12800}), f({19109, 3628800}), f({-83927, 3628800}), f({4997, 80640}), f({-661, 5670}),
     f({660127, 3628800}), f({-5143, 57600}), f({-76453, 3628800}), f({425, 290304})},
    // Row 8 (paper-j=+3):
    {f({425, 290304}), f({-5533, 403200}), f({210359, 3628800}), f({-530177, 3628800}),
     f({69, 280}), f({-218483, 725760}), f({1106377, 3628800}), f({-57251, 403200}),
     f({-8183, 1036800})},
    // Row 9 (paper-j=+4, corrector):
    {f({-8183, 1036800}), f({263077, 3628800}), f({-24019, 80640}), f({2616161, 3628800}),
     f({-6467, 5670}), f({500327, 403200}), f({-3498217, 3628800}), f({427487, 725760}),
     f({-19087, 89600})},
}};
...
inline constexpr std::array<std::array<double, kStencil>, kRows> kA = {{
    ...
    // Row 1 (paper-j=-4):
    {f({3250433, 53222400}), f({572741, 5702400}), f({-8701681, 39916800}), f({4026311, 13305600}),
     f({-917039, 3193344}), f({7370669, 39916800}), f({-1025779, 13305600}), f({754331, 39916800}),
     f({-330157, 159667200})},
    // Row 2 (paper-j=-3):
    {f({-330157, 159667200}), f({530113, 6652800}), f({518887, 19958400}), f({-27631, 623700}),
     f({44773, 1064448}), f({-531521, 19958400}), f({109343, 9979200}), f({-1261, 475200}),
     f({45911, 159667200})},
    // Row 3 (paper-j=-2):
    {f({45911, 159667200}), f({-185839, 39916800}), f({171137, 1900800}), f({73643, 39916800}),
     f({-25775, 3193344}), f({77597, 13305600}), f({-98911, 39916800}), f({24173, 39916800}),
     f({-3499, 53222400})},
    // Row 4 (paper-j=-1):
    {f({-3499, 53222400}), f({4387, 4989600}), f({-35039, 4989600}), f({90817, 950400}),
     f({-20561, 3193344}), f({2117, 9979200}), f({2059, 6652800}), f({-317, 2851200}),
     f({317, 22809600})},
    // Row 5 (paper-j= 0):
    {f({317, 22809600}), f({-2539, 13305600}), f({55067, 39916800}), f({-326911, 39916800}),
     f({14797, 152064}), f({-326911, 39916800}), f({55067, 39916800}), f({-2539, 13305600}),
     f({317, 22809600})},
    // Row 6 (paper-j=+1):
    {f({317, 22809600}), f({-317, 2851200}), f({2059, 6652800}), f({2117, 9979200}),
     f({-20561, 3193344}), f({90817, 950400}), f({-35039, 4989600}), f({4387, 4989600}),
     f({-3499, 53222400})},
    // Row 7 (paper-j=+2):
    {f({-3499, 53222400}), f({24173, 39916800}), f({-98911, 39916800}), f({77597, 13305600}),
     f({-25775, 3193344}), f({73643, 39916800}), f({171137, 1900800}), f({-185839, 39916800}),
     f({45911, 159667200})},
    // Row 8 (paper-j=+3):
    {f({45911, 159667200}), f({-1261, 475200}), f({109343, 9979200}), f({-531521, 19958400}),
     f({44773, 1064448}), f({-27631, 623700}), f({518887, 19958400}), f({530113, 6652800}),
     f({-330157, 159667200})},
    // Row 9 (paper-j=+4, corrector):
    {f({-330157, 159667200}), f({754331, 39916800}), f({-1025779, 13305600}),
     f({7370669, 39916800}), f({-917039, 3193344}), f({4026311, 13305600}), f({-8701681, 39916800}),
     f({572741, 5702400}), f({3250433, 53222400})},
}};
...
//   (j=+4, k=+4) = -19087/89600
static_assert(kB.at(1).at(0) == 19087.0 / 89600.0, "Table 5 anchor (j=-4, k=-4) drift");
static_assert(kB.at(9).at(8) == -19087.0 / 89600.0, "Table 5 anchor (j=+4, k=+4) drift");

// Plan-specified Table 6 anchor:
//   (j=+4, k=+4) = 3250433/53222400 ≈ 6.10737e-2
static_assert(kA.at(9).at(8) == 3250433.0 / 53222400.0, "Table 6 anchor (j=+4, k=+4) drift");
// Generator-cross-checked Table 6 anchors:
static_assert(kA.at(1).at(0) == 3250433.0 / 53222400.0, "Table 6 anchor (j=-4, k=-4) drift");
static_assert(kA.at(5).at(4) == 14797.0 / 152064.0, "Table 6 anchor (j=0, k=0) drift");
