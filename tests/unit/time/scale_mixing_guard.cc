...
// in tests/unit/time/CMakeLists.txt. This gtest is a beacon so that ctest
// output shows "scale-mixing guard ran"; if the configure-time check were
...
TEST(TimeScaleMixingGuard, ConfigureTimeCheckRecorded) {
  // Recorded marker; see scale_mixing_compile_fail.cc + CMakeLists.txt.
